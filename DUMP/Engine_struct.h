...
struct FPostProcessSettings {
	...
	char bOverride_DOFNearStart : 1; // 0x17(0x01)
	char bOverride_DOFNearEnd : 1; // 0x17(0x01)
	char bOverride_DOFFarStart : 1; // 0x17(0x01)
	char bOverride_DOFFarEnd : 1; // 0x17(0x01)
	char bOverride_DOFExcludedSize : 1; // 0x17(0x01)
	char bOverride_DOFPower : 1; // 0x17(0x01)
	char bOverride_DepthOfFieldDepthBlurAmount : 1; // 0x17(0x01)
	char bOverride_DepthOfFieldFocalRegion : 1; // 0x18(0x01)
	char bOverride_DepthOfFieldNearTransitionRegion : 1; // 0x18(0x01)
	char bOverride_DepthOfFieldFarTransitionRegion : 1; // 0x18(0x01)
	char bOverride_DepthOfFieldScale : 1; // 0x18(0x01)
	...
	char bOverride_DepthOfFieldSkyFocusDistance : 1; // 0x19(0x01)
	...
	float DOFNearStart; // 0x480(0x04)
	float DOFNearEnd; // 0x484(0x04)
	float DOFFarStart; // 0x488(0x04)
	float DOFFarEnd; // 0x48c(0x04)
	float DOFExcludedSize; // 0x490(0x04)
	float DOFPower; // 0x494(0x04)
	...
	float RayTracingReflectionsMaxRoughness; // 0x510(0x04)
	int32_t RayTracingReflectionsMaxBounces; // 0x514(0x04)
	int32_t RayTracingReflectionsSamplesPerPixel; // 0x518(0x04)
	enum class EReflectedAndRefractedRayTracedShadows RayTracingReflectionsShadows; // 0x51c(0x01)
	char RayTracingReflectionsTranslucency : 1; // 0x51d(0x01)
	char pad_51D_1 : 7; // 0x51d(0x01)
	enum class ETranslucencyType TranslucencyType; // 0x51e(0x01)
	char pad_51F[0x1]; // 0x51f(0x01)
	float RayTracingTranslucencyMaxRoughness; // 0x520(0x04)
	int32_t RayTracingTranslucencyRefractionRays; // 0x524(0x04)
	int32_t RayTracingTranslucencySamplesPerPixel; // 0x528(0x04)
	enum class EReflectedAndRefractedRayTracedShadows RayTracingTranslucencyShadows; // 0x52c(0x01)
	char RayTracingTranslucencyRefraction : 1; // 0x52d(0x01)
	char pad_52D_1 : 7; // 0x52d(0x01)
	char pad_52E[0x2]; // 0x52e(0x02)
	int32_t PathTracingMaxBounces; // 0x530(0x04)
	int32_t PathTracingSamplesPerPixel; // 0x534(0x04)
	float LPVFadeRange; // 0x538(0x04)
	float LPVDirectionalOcclusionFadeRange; // 0x53c(0x04)
	float ScreenPercentage; // 0x540(0x04)
